...
- **Ana Capability:** Terraform module standards and reusable infrastructure
- **Dönüşüm Wave:** 0
...
- `Terraform module standards and reusable infrastructure` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
