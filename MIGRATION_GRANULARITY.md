...
- Repository: `fintechbankx-platform-terraform-modules`
...
- dir: `infra/terraform/modules` -> `modules`
- dir: `infra/terraform/services` -> `services`
- file: `infra/terraform/README.md` -> `README.md`
